  ...
  while (true) {
    ...
    if (purchaseType !== null) {
      ...
      if (purchaseType === "NewNode") {
        ...
        logger.debug(
          `Node ${targetIndex}: ${purchaseType}-Upgrade für $${ns.format.number(bestCost)}`,
        );
      }
      await ns.sleep(100);
    } else {
